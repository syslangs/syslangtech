                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Ultimate 3D Bluetooth
                                                    Speaker</a> </h3>
                                            ...
                                            <div class="product-action">
                                                <a href="wishlist.php" class="btn-icon-wish" title="wishlist"><i
                                                        class="icon-heart"></i></a>
                                                <a href="product.php" class="btn-icon btn-add-cart"><i
                                                        class="fa fa-arrow-right"></i><span>SELECT
                                                        OPTIONS</span></a>
                                                <a href="ajax/product-quick-view.php" class="btn-quickview"
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Brown Women Casual HandBag</a>
                                            </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Circled Ultimate 3D
                                                    Speaker</a> </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Blue Backpack for the Young -
                                                    S</a> </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Casual Spring Blue Shoes</a>
                                            </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Men Black Gentle Belt</a>
                                            </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Brown-Black Men Casual
                                                    Glasses</a> </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Black Men Casual Glasses</a>
                                            </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Basketball Sports Blue
                                                    Shoes</a> </h3>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title"> <a href="product.php">Men Sports Travel Bag</a>
                                            </h3>
                                        ...
                                        <div class="owl-carousel widget-featured-products">
                                            <div class="featured-col">
                                                <div class="product-default left-details product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h3 class="product-title"> <a href="product.php">Blue Backpack for
                                                                the Young - S</a> </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                                ...
                                                <div class="product-default left-details product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h3 class="product-title"> <a href="product.php">Casual Spring Blue
                                                                Shoes</a> </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                                ...
                                                <div class="product-default left-details product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h3 class="product-title"> <a href="product.php">Men Black Gentle
                                                                Belt</a> </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="featured-col">
                                                <div class="product-default left-details product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h3 class="product-title"> <a href="product.php">Ultimate 3D
                                                ...
                                                <div class="product-default left-details product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h3 class="product-title"> <a href="product.php">Brown Women Casual
                                                                HandBag</a> </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                                ...
                                                <div class="product-default left-details product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h3 class="product-title"> <a href="product.php">Circled Ultimate
                                                                3D Speaker</a> </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
